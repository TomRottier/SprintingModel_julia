...
vcb = VectorContinuousCallback(condition, affect!, affect_neg!, 3, save_positions = (true, true))

# pocmy and pop2y with u
function pocmy(u, t, p)
    @unpack l7, mc, l8, md, me, mf, mg, mh, mi, ma, mb, l10, l9, l6, l4, l2, l1, l11, l3, footang = sol.prob.p
    @unpack ea, fa, ha, ia, gs = p
    @inbounds q1, q2, q3, q4, q5, q6, q7, u1, u2, u3, u4, u5, u6, u7 = sol(t)

    ea = ea(t); fa = fa(t); ha = ha(t); ia = ia(t); gs = gs(t)
