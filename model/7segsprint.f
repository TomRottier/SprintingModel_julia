...
C**   Created by AUTOLEV 3.2 on Sun Mar 06 16:26:25 2022
...
C**   Quantities to be specified
     ...
     &Z(197) + VRY1*Z(62)*Z(205) + Z(390)*(Z(37)*Z(38)+Z(39)*Z(40)) + Z(
     ...
     &38)**2 + RY2*Z(40)**2 + VRX1*Z(59)*Z(198) + VRX1*Z(61)*Z(206) + VR
     &Y1*Z(60)*Z(198) + VRY1*Z(62)*Z(206) + Z(390)*(Z(38)**2+Z(40)**2) +
     ...
     &+Z(62)*Z(206)) + Z(398)*(Z(72)*Z(260)+Z(74)*Z(270)) + Z(399)*(Z(72
     &)*Z(260)+Z(74)*Z(270))
      Z(742) = HTOR + Z(400) + Z(401) + Z(402) + L6*VRX1*Z(65) + L6*VRY1
     &*Z(66) + VRX1*Z(59)*Z(203) + VRX1*Z(61)*Z(220) + VRY1*Z(60)*Z(203)
     & + VRY1*Z(62)*Z(220) + Z(392)*(Z(34)*Z(149)+Z(36)*Z(156)) + Z(393)
     &*(Z(53)*Z(164)+Z(55)*Z(172)) + Z(394)*(Z(56)*Z(193)+Z(57)*Z(184)) 
     &+ Z(395)*(Z(60)*Z(203)+Z(62)*Z(216)) + Z(398)*(Z(72)*Z(265)+Z(74)*
     &Z(281)) + Z(399)*(Z(72)*Z(265)+Z(74)*Z(287)) + Z(397)*(Z(24)*Z(66)
     &+Z(25)*Z(70)+Z(60)*Z(203)+Z(62)*Z(220)) - MTOR - Z(741)*Z(40) - L5
     &*VRX1*Z(69) - L5*VRY1*Z(70) - L2*(RX2*Z(39)+RY2*Z(40)) - 0.5D0*Z(3
     &91)*(2*L2*Z(40)-L3*Z(47)-L4*Z(51)) - Z(396)*(L2*Z(40)-L10*Z(55)-L6
     &*Z(51)-L8*Z(36)-GS*Z(1))
      Z(745) = MTOR + Z(741)*Z(40) + Z(743)*Z(40) + Z(744)*Z(40) + VRX1*
     &Z(59)*Z(199) + VRX1*Z(61)*Z(207) + VRY1*Z(60)*Z(199) + VRY1*Z(62)*
     &Z(207) + L2*(RX2*Z(39)+RY2*Z(40)) + Z(392)*(Z(34)*Z(147)+Z(36)*Z(1
     ...
     &*(Z(72)*Z(261)+Z(74)*Z(271))
      Z(746) = MTOR + Z(741)*Z(40) + VRX1*Z(59)*Z(200) + VRX1*Z(61)*Z(20
     ...
     &(Z(72)*Z(262)+Z(74)*Z(272)) + Z(399)*(Z(72)*Z(262)+Z(74)*Z(272)) +
     & Z(396)*(L2*Z(40)-L6*Z(51)) + 0.5D0*Z(391)*(2*L2*Z(40)-L3*Z(47)-L4
     &*Z(51)) - Z(400)
      Z(747) = MTOR + Z(741)*Z(40) + VRX1*Z(59)*Z(201) + VRX1*Z(61)*Z(20
     ...
     &(Z(72)*Z(263)+Z(74)*Z(273)) + Z(399)*(Z(72)*Z(263)+Z(74)*Z(273)) +
     & Z(396)*(L2*Z(40)-L6*Z(51)-L8*Z(36)) + 0.5D0*Z(391)*(2*L2*Z(40)-L3
     &*Z(47)-L4*Z(51)) - Z(400) - Z(401)
      Z(748) = MTOR + Z(741)*Z(40) + VRX1*Z(59)*Z(202) + VRX1*Z(61)*Z(21
     ...
     &(Z(72)*Z(264)+Z(74)*Z(274)) + Z(399)*(Z(72)*Z(264)+Z(74)*Z(274)) +
...
C**   Evaluate output quantities
     ...
     &U4-Z(696)*U5-Z(697)*U6-Z(698)*U7-Z(699)*U3)
      ...
      SKANGVEL = FAp
      Z(288) = L2 + Z(268)
      Z(750) = Z(749)*Z(56) + L6*VRX1*Z(65) + L6*VRY1*Z(66) + Z(221)*VRX
     &1*Z(61) + Z(221)*VRY1*Z(62) + Z(398)*(Z(257)*Z(72)+Z(282)*Z(74)) +
     & Z(399)*(Z(257)*Z(72)+Z(288)*Z(74)) - L5*VRX1*Z(69) - L5*VRY1*Z(70
     &) - Z(196)*VRX1*Z(59) - Z(196)*VRY1*Z(60) - Z(395)*(Z(196)*Z(60)-Z
     &(217)*Z(62)) - Z(397)*(Z(196)*Z(60)-Z(24)*Z(66)-Z(25)*Z(70)-Z(221)
     &*Z(62))
     ...
     &Z(25)*Z(412)*Z(202))
      Z(289) = L2 + Z(267)
      Z(752) = Z(751)*Z(62) + L6*VRX1*Z(65) + L6*VRY1*Z(66) + L8*VRX1*Z(
     &61) + L8*VRY1*Z(62) + Z(398)*(Z(258)*Z(72)+Z(283)*Z(74)) + Z(399)*
     &(Z(258)*Z(72)+Z(289)*Z(74)) + Z(397)*(L8*Z(62)+Z(24)*Z(66)+Z(25)*Z
     ...
     &+Z(24)*Z(18)*Z(202)-Z(25)*Z(411)*Z(210)-Z(25)*Z(412)*Z(202))
      Z(286) = L2 - Z(276)
      Z(753) = L6*VRX1*Z(65) + L6*VRY1*Z(66) + Z(397)*(Z(24)*Z(66)+Z(25)
     &*Z(70)) + Z(398)*(Z(256)*Z(72)+Z(280)*Z(74)) + Z(399)*(Z(256)*Z(72
