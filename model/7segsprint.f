...
C**   Created by AUTOLEV 3.2 on Thu Feb 24 17:19:42 2022
     ...
     &STANCEX,VOCMSTANCEY,VOCMSWINGX,VOCMSWINGY,VOCMX,VOCMY,VOP2X,VOP2Y
      COMMON/MISCLLNS/ PI,DEGtoRAD,RADtoDEG,Z(687),COEF(7,7),RHS(7)
...
C**   Quantities to be specified
     ...
     &- 0.5D0*L3*U9
      ...
      Z(211) = Z(149) + Z(25)*U10 + Z(25)*U11 + Z(25)*U3 + Z(25)*U8 + Z(
     &25)*U9
      Z(212) = Z(25)*(FApp-EApp-HApp-IApp)
      Z(213) = U11 - IAp
      Z(214) = Z(211)*(U3+Z(115)+Z(190)+Z(204)+Z(213))
...
C**   Evaluate output quantities
     ...
     &(138)-Z(21)*U3-Z(21)*U8)**2+L8**2*(U3-U6-U7)**2+2*L8*Z(34)*U1*(U3-
     ...
     &U5-U6-U7)+2*L6*L8*Z(5)*(U3-U6-U7)*(U3-U5-U6-U7)+2*L2*Z(242)*(Z(138
     &)-Z(21)*U3-Z(21)*U8)*(U3-U4-U5-U6-U7)-2*Z(55)*U2*(Z(138)-Z(21)*U3-
     &Z(21)*U8)-2*Z(57)*U1*(Z(138)-Z(21)*U3-Z(21)*U8)-2*L2*Z(38)*U1*(U3-
     &U4-U5-U6-U7)-2*L2*Z(39)*U2*(U3-U4-U5-U6-U7)-2*L10*Z(254)*(U3-U7)*(
     &Z(138)-Z(21)*U3-Z(21)*U8)-2*L8*Z(250)*(U3-U6-U7)*(Z(138)-Z(21)*U3-
     &Z(21)*U8)-2*L10*L2*Z(234)*(U3-U7)*(U3-U4-U5-U6-U7)-2*L6*Z(246)*(Z(
     &138)-Z(21)*U3-Z(21)*U8)*(U3-U5-U6-U7)-2*L2*L8*Z(26)*(U3-U6-U7)*(U3
     ...
     &-U6-U7)**2+2*L6*GSp*Z(111)*(U3-U5-U6-U7)+2*L6*Z(49)*U1*(U3-U5-U6-U
     &7)+2*L6*Z(50)*U2*(U3-U5-U6-U7)+2*L6*GS*Z(113)*U3*(U3-U5-U6-U7)+L2*
     &*2*(U3-U4-U5-U6-U7)**2+2*L10*L8*Z(9)*(U3-U7)*(U3-U6-U7)+2*L10*L6*Z
     &(238)*(U3-U7)*(U3-U5-U6-U7)+2*L6*L8*Z(5)*(U3-U6-U7)*(U3-U5-U6-U7)-
     &2*GS*Z(2)*U1*U3-2*L2*GSp*Z(106)*(U3-U4-U5-U6-U7)-2*L2*Z(38)*U1*(U3
     &-U4-U5-U6-U7)-2*L2*Z(39)*U2*(U3-U4-U5-U6-U7)-2*L2*GS*Z(108)*U3*(U3
     &-U4-U5-U6-U7)-2*L10*L2*Z(234)*(U3-U7)*(U3-U4-U5-U6-U7)-2*L2*L8*Z(2
     &6)*(U3-U6-U7)*(U3-U4-U5-U6-U7)-2*L2*L6*Z(3)*(U3-U5-U6-U7)*(U3-U4-U
     &5-U6-U7)) + 0.5D0*MI*(U1**2+U2**2+L11**2*U3**2+2*L11*Z(1)*U2*U3+L1
     &0**2*(U3-U7)**2+2*L10*Z(53)*U1*(U3-U7)+2*L10*Z(54)*U2*(U3-U7)+2*L1
     &0*L11*Z(11)*U3*(U3-U7)+L8**2*(U3-U6-U7)**2+2*L8*Z(34)*U1*(U3-U6-U7
     &)+2*L8*Z(35)*U2*(U3-U6-U7)+2*L11*L8*Z(29)*U3*(U3-U6-U7)+L6**2*(U3-
     &U5-U6-U7)**2+2*L6*Z(49)*U1*(U3-U5-U6-U7)+2*L6*Z(50)*U2*(U3-U5-U6-U
     &7)+(Z(149)+Z(25)*U10+Z(25)*U11+Z(25)*U3+Z(25)*U8+Z(25)*U9)**2+2*L1
     &1*L6*Z(113)*U3*(U3-U5-U6-U7)+L2**2*(U3-U4-U5-U6-U7)**2+2*L10*L8*Z(
     &9)*(U3-U7)*(U3-U6-U7)+2*Z(72)*U1*(Z(149)+Z(25)*U10+Z(25)*U11+Z(25)
     &*U3+Z(25)*U8+Z(25)*U9)+2*Z(73)*U2*(Z(149)+Z(25)*U10+Z(25)*U11+Z(25
     &)*U3+Z(25)*U8+Z(25)*U9)+2*L10*L6*Z(238)*(U3-U7)*(U3-U5-U6-U7)+2*L1
     &1*Z(133)*U3*(Z(149)+Z(25)*U10+Z(25)*U11+Z(25)*U3+Z(25)*U8+Z(25)*U9
     &)+2*L6*L8*Z(5)*(U3-U6-U7)*(U3-U5-U6-U7)+2*L10*Z(330)*(U3-U7)*(Z(14
     &9)+Z(25)*U10+Z(25)*U11+Z(25)*U3+Z(25)*U8+Z(25)*U9)+2*L8*Z(326)*(U3
     &-U6-U7)*(Z(149)+Z(25)*U10+Z(25)*U11+Z(25)*U3+Z(25)*U8+Z(25)*U9)+2*
     &L6*Z(322)*(U3-U5-U6-U7)*(Z(149)+Z(25)*U10+Z(25)*U11+Z(25)*U3+Z(25)
     &*U8+Z(25)*U9)-2*L11*Z(2)*U1*U3-2*L2*Z(38)*U1*(U3-U4-U5-U6-U7)-2*L2
     &*Z(39)*U2*(U3-U4-U5-U6-U7)-2*L11*L2*Z(108)*U3*(U3-U4-U5-U6-U7)-2*L
     &10*L2*Z(234)*(U3-U7)*(U3-U4-U5-U6-U7)-2*L2*L8*Z(26)*(U3-U6-U7)*(U3
     &-U4-U5-U6-U7)-2*L2*L6*Z(3)*(U3-U5-U6-U7)*(U3-U4-U5-U6-U7)-2*L2*Z(3
     &18)*(U3-U4-U5-U6-U7)*(Z(149)+Z(25)*U10+Z(25)*U11+Z(25)*U3+Z(25)*U8
     &+Z(25)*U9)) - 0.5D0*MA*(2*L1*Z(38)*U1*(U3-U4-U5-U6-U7)+2*L1*Z(39)*
     &U2*(U3-U4-U5-U6-U7)-U1**2-U2**2-L1**2*(U3-U4-U5-U6-U7)**2) - 0.5D0
     &*MF*(2*Z(55)*U2*(Z(139)-L10*U3-L10*U8)+2*Z(57)*U1*(Z(139)-L10*U3-L
     &10*U8)+2*L2*Z(38)*U1*(U3-U4-U5-U6-U7)+2*L2*Z(39)*U2*(U3-U4-U5-U6-U
     &7)+2*Z(60)*U1*(Z(140)-Z(22)*U3-Z(22)*U8-Z(22)*U9)+2*Z(61)*U2*(Z(14
     &0)-Z(22)*U3-Z(22)*U8-Z(22)*U9)+2*L10*Z(254)*(U3-U7)*(Z(139)-L10*U3
     &-L10*U8)+2*L8*Z(250)*(U3-U6-U7)*(Z(139)-L10*U3-L10*U8)+2*L10*L2*Z(
     &234)*(U3-U7)*(U3-U4-U5-U6-U7)+2*L10*Z(270)*(U3-U7)*(Z(140)-Z(22)*U
     &3-Z(22)*U8-Z(22)*U9)+2*L6*Z(246)*(Z(139)-L10*U3-L10*U8)*(U3-U5-U6-
     &U7)+2*L2*L8*Z(26)*(U3-U6-U7)*(U3-U4-U5-U6-U7)+2*L8*Z(266)*(U3-U6-U
     &7)*(Z(140)-Z(22)*U3-Z(22)*U8-Z(22)*U9)+2*Z(15)*(Z(139)-L10*U3-L10*
     &U8)*(Z(140)-Z(22)*U3-Z(22)*U8-Z(22)*U9)+2*L2*L6*Z(3)*(U3-U5-U6-U7)
     &*(U3-U4-U5-U6-U7)+2*L6*Z(262)*(U3-U5-U6-U7)*(Z(140)-Z(22)*U3-Z(22)
     &*U8-Z(22)*U9)-U1**2-U2**2-2*L10*Z(53)*U1*(U3-U7)-2*L10*Z(54)*U2*(U
     &3-U7)-L10**2*(U3-U7)**2-2*L8*Z(34)*U1*(U3-U6-U7)-2*L8*Z(35)*U2*(U3
     &-U6-U7)-(Z(139)-L10*U3-L10*U8)**2-L8**2*(U3-U6-U7)**2-2*L6*Z(49)*U
     &1*(U3-U5-U6-U7)-2*L6*Z(50)*U2*(U3-U5-U6-U7)-L6**2*(U3-U5-U6-U7)**2
     &-(Z(140)-Z(22)*U3-Z(22)*U8-Z(22)*U9)**2-2*L10*L8*Z(9)*(U3-U7)*(U3-
     &U6-U7)-L2**2*(U3-U4-U5-U6-U7)**2-2*L10*L6*Z(238)*(U3-U7)*(U3-U5-U6
     &-U7)-2*L6*L8*Z(5)*(U3-U6-U7)*(U3-U5-U6-U7)-2*L2*Z(242)*(Z(139)-L10
     &*U3-L10*U8)*(U3-U4-U5-U6-U7)-2*L2*Z(258)*(U3-U4-U5-U6-U7)*(Z(140)-
     &Z(22)*U3-Z(22)*U8-Z(22)*U9)) - 0.125D0*MH*(8*Z(55)*U2*(Z(139)-L10*
     &U3-L10*U8)+8*Z(57)*U1*(Z(139)-L10*U3-L10*U8)+4*Z(68)*U1*(Z(147)+L3
     &*U10+L3*U3+L3*U8+L3*U9)+4*Z(69)*U2*(Z(147)+L3*U10+L3*U3+L3*U8+L3*U
     &9)+8*L2*Z(38)*U1*(U3-U4-U5-U6-U7)+8*L2*Z(39)*U2*(U3-U4-U5-U6-U7)+8
     &*Z(60)*U1*(Z(141)-L8*U3-L8*U8-L8*U9)+8*Z(61)*U2*(Z(141)-L8*U3-L8*U
     &8-L8*U9)+8*L10*Z(254)*(U3-U7)*(Z(139)-L10*U3-L10*U8)+4*L10*Z(302)*
     &(U3-U7)*(Z(147)+L3*U10+L3*U3+L3*U8+L3*U9)+8*L8*Z(250)*(U3-U6-U7)*(
     &Z(139)-L10*U3-L10*U8)+8*L10*L2*Z(234)*(U3-U7)*(U3-U4-U5-U6-U7)+8*L
     &10*Z(270)*(U3-U7)*(Z(141)-L8*U3-L8*U8-L8*U9)+4*L8*Z(294)*(U3-U6-U7
     &)*(Z(147)+L3*U10+L3*U3+L3*U8+L3*U9)+8*L6*Z(246)*(Z(139)-L10*U3-L10
     &*U8)*(U3-U5-U6-U7)+8*L2*L8*Z(26)*(U3-U6-U7)*(U3-U4-U5-U6-U7)+8*L8*
     &Z(266)*(U3-U6-U7)*(Z(141)-L8*U3-L8*U8-L8*U9)+8*Z(306)*(Z(139)-L10*
     &U3-L10*U8)*(Z(146)+Z(24)*U10+Z(24)*U3+Z(24)*U8+Z(24)*U9)+4*L6*Z(28
     &6)*(U3-U5-U6-U7)*(Z(147)+L3*U10+L3*U3+L3*U8+L3*U9)+8*Z(15)*(Z(139)
     &-L10*U3-L10*U8)*(Z(141)-L8*U3-L8*U8-L8*U9)+4*Z(7)*(Z(146)+Z(24)*U1
     &0+Z(24)*U3+Z(24)*U8+Z(24)*U9)*(Z(147)+L3*U10+L3*U3+L3*U8+L3*U9)+8*
     &L2*L6*Z(3)*(U3-U5-U6-U7)*(U3-U4-U5-U6-U7)+8*L6*Z(262)*(U3-U5-U6-U7
     &)*(Z(141)-L8*U3-L8*U8-L8*U9)+8*L2*Z(274)*(Z(146)+Z(24)*U10+Z(24)*U
     &3+Z(24)*U8+Z(24)*U9)*(U3-U4-U5-U6-U7)-4*U1**2-4*U2**2-8*L10*Z(53)*
     &U1*(U3-U7)-8*L10*Z(54)*U2*(U3-U7)-4*L10**2*(U3-U7)**2-8*L8*Z(34)*U
     &1*(U3-U6-U7)-8*L8*Z(35)*U2*(U3-U6-U7)-4*(Z(139)-L10*U3-L10*U8)**2-
     &4*L8**2*(U3-U6-U7)**2-8*L6*Z(49)*U1*(U3-U5-U6-U7)-8*L6*Z(50)*U2*(U
     &3-U5-U6-U7)-4*(Z(146)+Z(24)*U10+Z(24)*U3+Z(24)*U8+Z(24)*U9)**2-4*L
     &6**2*(U3-U5-U6-U7)**2-(Z(147)+L3*U10+L3*U3+L3*U8+L3*U9)**2-8*Z(64)
     &*U1*(Z(146)+Z(24)*U10+Z(24)*U3+Z(24)*U8+Z(24)*U9)-8*Z(65)*U2*(Z(14
     &6)+Z(24)*U10+Z(24)*U3+Z(24)*U8+Z(24)*U9)-4*(Z(141)-L8*U3-L8*U8-L8*
     &U9)**2-8*L10*L8*Z(9)*(U3-U7)*(U3-U6-U7)-4*L2**2*(U3-U4-U5-U6-U7)**
     &2-8*L10*L6*Z(238)*(U3-U7)*(U3-U5-U6-U7)-8*L10*Z(298)*(U3-U7)*(Z(14
     &6)+Z(24)*U10+Z(24)*U3+Z(24)*U8+Z(24)*U9)-8*L6*L8*Z(5)*(U3-U6-U7)*(
     &U3-U5-U6-U7)-8*L8*Z(290)*(U3-U6-U7)*(Z(146)+Z(24)*U10+Z(24)*U3+Z(2
     &4)*U8+Z(24)*U9)-4*Z(310)*(Z(139)-L10*U3-L10*U8)*(Z(147)+L3*U10+L3*
     &U3+L3*U8+L3*U9)-8*L2*Z(242)*(Z(139)-L10*U3-L10*U8)*(U3-U4-U5-U6-U7
     &)-8*L6*Z(282)*(U3-U5-U6-U7)*(Z(146)+Z(24)*U10+Z(24)*U3+Z(24)*U8+Z(
     &24)*U9)-8*Z(17)*(Z(146)+Z(24)*U10+Z(24)*U3+Z(24)*U8+Z(24)*U9)*(Z(1
     &41)-L8*U3-L8*U8-L8*U9)-4*L2*Z(278)*(Z(147)+L3*U10+L3*U3+L3*U8+L3*U
     &9)*(U3-U4-U5-U6-U7)-4*Z(314)*(Z(147)+L3*U10+L3*U3+L3*U8+L3*U9)*(Z(
     &141)-L8*U3-L8*U8-L8*U9)-8*L2*Z(258)*(U3-U4-U5-U6-U7)*(Z(141)-L8*U3
     &-L8*U8-L8*U9))
     ...
     &NI*U9 + 0.5D0*Z(394)*U2 + 0.5D0*Z(400)*U2 + 0.5D0*Z(408)*U2 + 0.5D
     &0*Z(414)*U2 + 0.5D0*Z(421)*U2 + 0.5D0*Z(429)*U2 + 0.5D0*Z(437)*U1 
     &+ 0.5D0*Z(446)*U2 + 0.5D0*Z(457)*U1 + 0.25D0*Z(398)*Z(166) + 0.25D
     &0*Z(402)*Z(167) + 0.5D0*Z(405)*Z(172) + 0.5D0*Z(406)*Z(174) + 0.5D
     &0*Z(410)*Z(172) + 0.5D0*Z(411)*Z(176) + 0.5D0*Z(412)*Z(178) + 0.5D
     &0*Z(416)*Z(172) + 0.5D0*Z(417)*Z(176) + 0.5D0*Z(418)*Z(180) + 0.5D
     &0*Z(423)*Z(172) + 0.5D0*Z(424)*Z(176) + 0.5D0*Z(425)*Z(180) + 0.5D
     &0*Z(427)*Z(188) + 0.5D0*Z(430)*Z(164) + 0.5D0*Z(439)*Z(172) + 0.5D
     &0*Z(440)*Z(176) + 0.5D0*Z(441)*Z(180) + 0.5D0*Z(443)*Z(192) + 0.5D
     &0*Z(445)*Z(201) + 0.5D0*Z(449)*Z(202) + 0.5D0*Z(450)*Z(164) - Z(33
     &1) - 0.5D0*Z(435) - IND*U7 - 0.5D0*Z(395)*U1 - 0.5D0*Z(399)*U1 - 0
     &.5D0*Z(407)*U1 - 0.5D0*Z(413)*U1 - 0.5D0*Z(420)*U1 - 0.5D0*Z(428)*
     &U1 - 0.5D0*Z(436)*U2 - 0.5D0*Z(447)*U1 - 0.5D0*Z(456)*U2 - INC*(U6
     &+U7) - INB*(U5+U6+U7) - INA*(U4+U5+U6+U7) - 0.5D0*Z(393)*Z(162) - 
     &0.5D0*Z(396)*Z(164) - 0.5D0*Z(403)*Z(164) - 0.5D0*Z(409)*Z(164) - 
     &0.5D0*Z(415)*Z(164) - 0.5D0*Z(419)*Z(182) - 0.5D0*Z(422)*Z(164) - 
     &0.5D0*Z(426)*Z(185) - 0.5D0*Z(431)*Z(172) - 0.5D0*Z(432)*Z(176) - 
     &0.5D0*Z(433)*Z(180) - 0.5D0*Z(434)*Z(195) - 0.5D0*Z(438)*Z(164) - 
     &0.5D0*Z(442)*Z(185) - 0.5D0*Z(451)*Z(172) - 0.5D0*Z(452)*Z(176) - 
     &0.5D0*Z(453)*Z(180) - 0.5D0*Z(454)*Z(199) - 0.5D0*Z(455)*Z(211)
      Z(486) = MG*GSp
      Z(495) = MH*Z(146)
      Z(503) = MI*Z(149)
      Z(487) = MG*GS
     ...
     &+Z(494)*U9) + (Z(468)+Z(472)+Z(478)+Z(485)+Z(491)+Z(501))*Z(53)*(U
     &3-U7) + Z(72)*(Z(503)+Z(502)*U10+Z(502)*U11+Z(502)*U3+Z(502)*U8+Z(
     &502)*U9) + (Z(464)+Z(467)+Z(471)+Z(477)+Z(484)+Z(490)+Z(500))*Z(34
     &)*(U3-U6-U7) + 0.5D0*(Z(460)+2*Z(463)+2*Z(466)+2*Z(470)+2*Z(476)+2
     &*Z(483)+2*Z(489)+2*Z(499))*Z(49)*(U3-U5-U6-U7) - (Z(81)+Z(487))*Z(
     &2)*U3 - 0.5D0*Z(68)*(Z(497)+Z(496)*U10+Z(496)*U3+Z(496)*U8+Z(496)*
     &U9) - (Z(458)+Z(459)+Z(462)+Z(465)+Z(469)+Z(475)+Z(482)+Z(488)+Z(4
     &98))*Z(38)*(U3-U4-U5-U6-U7) - Z(60)*(Z(481)+Z(493)-Z(480)*U3-Z(480
     &)*U8-Z(480)*U9-Z(490)*U3-Z(490)*U8-Z(490)*U9) - Z(57)*(Z(474)+Z(47
     &9)+Z(492)-Z(473)*U3-Z(473)*U8-Z(478)*U3-Z(478)*U8-Z(491)*U3-Z(491)
     &*U8)
      PY = Z(486)*Z(2) + (Z(81)+Z(487))*Z(1)*U3 + (MA+MB+MC+MD+ME+MF+MG+
     &MH+MI)*U2 + 0.5D0*Z(461)*Z(46)*(U3-U5-U6-U7) + Z(65)*(Z(495)+Z(494
     &)*U10+Z(494)*U3+Z(494)*U8+Z(494)*U9) + (Z(468)+Z(472)+Z(478)+Z(485
     &)+Z(491)+Z(501))*Z(54)*(U3-U7) + Z(73)*(Z(503)+Z(502)*U10+Z(502)*U
     &11+Z(502)*U3+Z(502)*U8+Z(502)*U9) + (Z(464)+Z(467)+Z(471)+Z(477)+Z
     &(484)+Z(490)+Z(500))*Z(35)*(U3-U6-U7) + 0.5D0*(Z(460)+2*Z(463)+2*Z
     &(466)+2*Z(470)+2*Z(476)+2*Z(483)+2*Z(489)+2*Z(499))*Z(50)*(U3-U5-U
     &6-U7) - 0.5D0*Z(69)*(Z(497)+Z(496)*U10+Z(496)*U3+Z(496)*U8+Z(496)*
     &U9) - (Z(458)+Z(459)+Z(462)+Z(465)+Z(469)+Z(475)+Z(482)+Z(488)+Z(4
     &98))*Z(39)*(U3-U4-U5-U6-U7) - Z(61)*(Z(481)+Z(493)-Z(480)*U3-Z(480
     &)*U8-Z(480)*U9-Z(490)*U3-Z(490)*U8-Z(490)*U9) - Z(55)*(Z(474)+Z(47
     &9)+Z(492)-Z(473)*U3-Z(473)*U8-Z(478)*U3-Z(478)*U8-Z(491)*U3-Z(491)
     &*U8)
     ...
     &)*Z(258))-MH*(L3*Z(278)-2*L10*Z(242)-2*L8*Z(258)-2*Z(24)*Z(274)))
      SHTOR = Z(684) - Z(642)*U3p - Z(643)*U2p - Z(644)*U1p - Z(645)*U7p
     ...
     &*U6p + Z(656)*U5p + 0.5D0*Z(657)*U4p - Z(685)
      Z(660) = Z(659) - Z(502)*(L2*Z(318)-Z(25)-L10*Z(330)-L11*Z(133)-L6
     &*Z(322)-L8*Z(326)) - 0.25D0*MH*(4*Z(599)+4*Z(600)*Z(17)+2*Z(601)*Z
     &(302)+2*Z(601)*Z(310)+2*Z(602)*Z(286)+2*Z(603)*Z(294)+2*Z(603)*Z(3
     &14)+4*Z(604)*Z(274)-4*Z(606)-Z(605)-4*Z(600)*Z(290)-4*Z(607)*Z(298
     &)-4*Z(607)*Z(306)-4*Z(608)*Z(282)-2*Z(559)*Z(278))
      Z(661) = Z(502)*Z(72) - 0.5D0*MH*(L3*Z(68)-2*Z(24)*Z(64))
      Z(662) = Z(502)*Z(73) - 0.5D0*MH*(L3*Z(69)-2*Z(24)*Z(65))
      Z(663) = Z(502)*(L2*Z(318)-L10*Z(330)-L6*Z(322)-L8*Z(326)) + 0.5D0
     &*MH*(Z(601)*Z(302)+Z(602)*Z(286)+Z(603)*Z(294)+2*Z(604)*Z(274)-2*Z
     &(600)*Z(290)-2*Z(607)*Z(298)-2*Z(608)*Z(282)-Z(559)*Z(278))
      Z(664) = Z(502)*(L2*Z(318)-L6*Z(322)-L8*Z(326)) + 0.5D0*MH*(Z(602)
     &*Z(286)+Z(603)*Z(294)+2*Z(604)*Z(274)-2*Z(600)*Z(290)-2*Z(608)*Z(2
     &82)-Z(559)*Z(278))
      Z(665) = Z(502)*(L2*Z(318)-L6*Z(322)) + 0.5D0*MH*(Z(602)*Z(286)+2*
     &Z(604)*Z(274)-2*Z(608)*Z(282)-Z(559)*Z(278))
      Z(666) = L2*(2*Z(502)*Z(318)-MH*(L3*Z(278)-2*Z(24)*Z(274)))
      Z(526) = Z(522)*Z(73) + L2*Z(73)*Z(227) - 0.5D0*Z(225)*(L3*Z(69)-2
     &*Z(24)*Z(65))
      Z(667) = Z(541) + Z(543) + Z(502)*(Z(212)+Z(316)*Z(165)-Z(131)*Z(2
     &00)-Z(320)*Z(173)-Z(324)*Z(177)-Z(328)*Z(181)) + 0.25D0*MH*(L3*Z(2
     &05)+4*Z(24)*Z(203)+4*Z(24)*Z(17)*Z(193)+2*L3*Z(186)*Z(310)+2*L3*Z(
     &193)*Z(314)+2*Z(616)*Z(206)+4*Z(618)*Z(207)+2*L3*Z(284)*Z(173)+2*L
     &3*Z(292)*Z(177)+2*L3*Z(300)*Z(181)+2*L3*Z(308)*Z(187)+2*L3*Z(312)*
     &Z(194)+4*Z(24)*Z(18)*Z(194)+4*Z(24)*Z(272)*Z(165)-2*Z(619)*Z(203)-
     &2*Z(620)*Z(205)-4*Z(24)*Z(186)*Z(306)-4*Z(24)*Z(280)*Z(173)-4*Z(24
     &)*Z(288)*Z(177)-4*Z(24)*Z(296)*Z(181)-4*Z(24)*Z(304)*Z(187)-2*L3*Z
     &(276)*Z(165))
      Z(686) = Z(526) - Z(667)
      SATOR = Z(660)*U3p + Z(661)*U1p + Z(662)*U2p + Z(663)*U7p + Z(664)
     &*U6p + Z(665)*U5p + 0.5D0*Z(666)*U4p - Z(686)
      Z(668) = INI - Z(502)*(L2*Z(318)-Z(25)-L10*Z(330)-L11*Z(133)-L6*Z(
     &322)-L8*Z(326))
      Z(669) = Z(502)*Z(72)
      Z(670) = Z(502)*Z(73)
      Z(671) = Z(502)*(L2*Z(318)-L10*Z(330)-L6*Z(322)-L8*Z(326))
      Z(672) = Z(502)*(L2*Z(318)-L6*Z(322)-L8*Z(326))
      Z(673) = Z(502)*(L2*Z(318)-L6*Z(322))
      Z(675) = Z(674)*Z(318)
      Z(527) = Z(73)*(Z(522)+L2*Z(227))
      Z(676) = Z(543) + Z(502)*(Z(212)+Z(316)*Z(165)-Z(131)*Z(200)-Z(320
     &)*Z(173)-Z(324)*Z(177)-Z(328)*Z(181))
      Z(687) = Z(527) - Z(676)
      SMTOR = Z(668)*U3p + Z(669)*U1p + Z(670)*U2p + Z(671)*U7p + Z(672)
     &*U6p + Z(673)*U5p + Z(675)*U4p - Z(687)
      POP1X = Q1
      POP1Y = Q2
     ...
     &72)*(Z(155)+Z(84)*U10+Z(84)*U11+Z(84)*U3+Z(84)*U8+Z(84)*U9) - Z(82
     &)*Z(2)*U3 - Z(57)*(Z(152)-Z(79)*U3-Z(79)*U8) - 0.5D0*Z(68)*(Z(156)
     &+Z(85)*U10+Z(85)*U3+Z(85)*U8+Z(85)*U9) - Z(75)*Z(38)*(U3-U4-U5-U6-
     &U7) - Z(60)*(Z(153)-Z(80)*U3-Z(80)*U8-Z(80)*U9)
     ...
     &8+Z(83)*U9) + Z(73)*(Z(155)+Z(84)*U10+Z(84)*U11+Z(84)*U3+Z(84)*U8+
     &Z(84)*U9) - Z(55)*(Z(152)-Z(79)*U3-Z(79)*U8) - 0.5D0*Z(69)*(Z(156)
     &+Z(85)*U10+Z(85)*U3+Z(85)*U8+Z(85)*U9) - Z(75)*Z(39)*(U3-U4-U5-U6-
     &U7) - Z(61)*(Z(153)-Z(80)*U3-Z(80)*U8-Z(80)*U9)
     ...
     &1)*U8+Z(101)*U9) + Z(72)*(Z(160)+Z(102)*U10+Z(102)*U11+Z(102)*U3+Z
     &(102)*U8+Z(102)*U9) - Z(100)*Z(2)*U3 - Z(57)*(Z(157)-Z(98)*U3-Z(98
     &)*U8) - 0.5D0*Z(68)*(Z(161)+Z(103)*U10+Z(103)*U3+Z(103)*U8+Z(103)*
     &U9) - Z(94)*Z(38)*(U3-U4-U5-U6-U7) - Z(60)*(Z(158)-Z(99)*U3-Z(99)*
     &U8-Z(99)*U9)
      VOCMSWINGY = U2 + Z(100)*Z(1)*U3 + Z(97)*Z(54)*(U3-U7) + Z(96)*Z(3
     &5)*(U3-U6-U7) + Z(95)*Z(50)*(U3-U5-U6-U7) + Z(65)*(Z(159)+Z(101)*U
     &10+Z(101)*U3+Z(101)*U8+Z(101)*U9) + Z(73)*(Z(160)+Z(102)*U10+Z(102
     &)*U11+Z(102)*U3+Z(102)*U8+Z(102)*U9) - Z(55)*(Z(157)-Z(98)*U3-Z(98
     &)*U8) - 0.5D0*Z(69)*(Z(161)+Z(103)*U10+Z(103)*U3+Z(103)*U8+Z(103)*
     &U9) - Z(94)*Z(39)*(U3-U4-U5-U6-U7) - Z(61)*(Z(158)-Z(99)*U3-Z(99)*
     &U8-Z(99)*U9)
      SAANG = HA
      SMANG = IA
      SAANGVEL = HAp
