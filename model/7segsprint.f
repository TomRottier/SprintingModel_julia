...
C**   Created by AUTOLEV 3.2 on Thu Feb 24 18:33:19 2022
...
C**   Quantities to be specified
     ...
     &Z(291)+L8*Z(209)*Z(295)+L8*Z(209)*Z(315)+Z(623)*Z(211)+L10*Z(16)*Z
     ...
     &0)-L10*Z(237)*Z(173)-L10*Z(245)*Z(173)-L10*Z(249)*Z(177)-L10*Z(253
...
C**   Evaluate output quantities
     ...
     &Z(623)*Z(211)+L10*Z(16)*Z(194)+L10*Z(241)*Z(165)+L8*Z(257)*Z(165)+
     &Z(24)*Z(18)*Z(194)+Z(24)*Z(273)*Z(165)+Z(25)*Z(277)*Z(165)-L10*Z(1
     &86)-L8*Z(193)-L8*Z(17)*Z(208)-Z(24)*Z(186)*Z(307)-Z(25)*Z(186)*Z(3
     &11)-Z(25)*Z(193)*Z(315)-Z(624)*Z(210)-L10*Z(245)*Z(173)-L10*Z(249)
     ...
     &(15)*Z(186)+Z(24)*Z(17)*Z(193)+L8*Z(209)*Z(315)+Z(623)*Z(211)+L8*Z
     &(257)*Z(165)+Z(24)*Z(18)*Z(194)+Z(24)*Z(273)*Z(165)+Z(25)*Z(277)*Z
     &(165)-L8*Z(193)-L8*Z(17)*Z(208)-Z(24)*Z(186)*Z(307)-Z(25)*Z(186)*Z
     &(311)-Z(25)*Z(193)*Z(315)-Z(624)*Z(210)-L8*Z(16)*Z(187)-L8*Z(18)*Z
     ...
     &209)+Z(622)*Z(208)+Z(24)*Z(17)*Z(193)+Z(623)*Z(211)+Z(24)*Z(18)*Z(
     &194)+Z(24)*Z(273)*Z(165)+Z(25)*Z(277)*Z(165)-Z(24)*Z(186)*Z(307)-Z
     &(25)*Z(186)*Z(311)-Z(25)*Z(193)*Z(315)-Z(624)*Z(210)-Z(24)*Z(281)*
