# Automatically generated
          function eom(u,p,t)
              ...
              # specified variables
              rmtp = _rmtp(t); ra = _ra(t); rk = _rk(t); rh = _rh(t); la = _la(t); lmtp = _lmtp(t); lh = _lh(t); lk = _lk(t); lkp = _lkp(t); lap = _lap(t); lhp = _lhp(t); lmtpp = _lmtpp(t); rhp = _rhp(t); rkp = _rkp(t); rap = _rap(t); rmtpp = _rmtpp(t); rs = _rs(t); ls = _ls(t); re = _re(t); le = _le(t); rkpp = _rkpp(t); rhpp = _rhpp(t); lkpp = _lkpp(t); lhpp = _lhpp(t); rapp = _rapp(t); lapp = _lapp(t); rmtppp = _rmtppp(t); lmtppp = _lmtppp(t); rsp = _rsp(t); lsp = _lsp(t); repp = _repp(t); rspp = _rspp(t); lepp = _lepp(t); lspp = _lspp(t); rep = _rep(t); lep = _lep(t)
	...
	z[1157] = lrx1 + lrx2 * z[39] ^ 2 + lrx2 * z[41] ^ 2 + lry2 * z[39] * z[40] + lry2 * z[41] * z[42] + rrx1 * z[72] * z[290] + rrx1 * z[74] * z[299] + rrx2 * z[64] * z[266] + rrx2 * z[66] * z[274] + rry1 * z[73] * z[290] + rry1 * z[75] * z[299] + rry2 * z[65] * z[266] + rry2 * z[67] * z[274] + z[542] * (z[1] * z[325] + z[2] * z[319]) + z[543] * (z[39] * z[40] + z[41] * z[42]) + z[543] * (z[73] * z[290] + z[75] * z[299]) + z[544] * (z[80] * z[354] + z[82] * z[362]) + z[544] * (z[87] * z[399] + z[89] * z[407]) + z[545] * (z[39] * z[40] + z[41] * z[42]) + z[545] * (z[61] * z[232] + z[63] * z[240]) + z[546] * (z[36] * z[177] + z[38] * z[181]) + z[546] * (z[61] * z[232] + z[63] * z[240]) + z[547] * (z[54] * z[198] + z[55] * z[193]) + z[547] * (z[57] * z[219] + z[58] * z[213]) + z[548] * (z[76] * z[341] + z[77] * z[334]) + z[548] * (z[83] * z[386] + z[84] * z[379])
	z[1158] = lry1 + lrx2 * z[39] * z[40] + lrx2 * z[41] * z[42] + lry2 * z[40] ^ 2 + lry2 * z[42] ^ 2 + rrx1 * z[72] * z[291] + rrx1 * z[74] * z[300] + rrx2 * z[64] * z[267] + rrx2 * z[66] * z[275] + rry1 * z[73] * z[291] + rry1 * z[75] * z[300] + rry2 * z[65] * z[267] + rry2 * z[67] * z[275] + z[542] * (z[1] * z[326] + z[2] * z[320]) + z[543] * (z[40] ^ 2 + z[42] ^ 2) + z[543] * (z[73] * z[291] + z[75] * z[300]) + z[544] * (z[80] * z[355] + z[82] * z[363]) + z[544] * (z[87] * z[400] + z[89] * z[408]) + z[545] * (z[40] ^ 2 + z[42] ^ 2) + z[545] * (z[61] * z[233] + z[63] * z[241]) + z[546] * (z[36] * z[178] + z[38] * z[182]) + z[546] * (z[61] * z[233] + z[63] * z[241]) + z[547] * (z[54] * z[199] + z[55] * z[194]) + z[547] * (z[57] * z[220] + z[58] * z[214]) + z[548] * (z[76] * z[342] + z[77] * z[335]) + z[548] * (z[83] * z[387] + z[84] * z[380])
	z[1176] = iff * z[136]
	z[1178] = ila * z[150]
	z[1180] = irf * z[124]
	z[1182] = ish * z[116]
	...
	z[1287] = (((((z[264] * rrx2 * z[64] + z[264] * rry2 * z[65] + z[279] * rrx2 * z[66] + z[279] * rry2 * z[67] + z[287] * rrx1 * z[72] + z[287] * rry1 * z[73] + z[311] * rrx1 * z[74] + z[311] * rry1 * z[75] + z[542] * (z[317] * z[2] + z[328] * z[1]) + z[543] * (z[287] * z[73] + z[305] * z[75]) + z[544] * (z[353] * z[80] + z[369] * z[82]) + z[544] * (z[398] * z[87] + z[414] * z[89]) + z[546] * (z[176] * z[36] + z[186] * z[38]) + z[546] * (z[229] * z[61] + z[246] * z[63]) + z[547] * (z[192] * z[55] + z[202] * z[54]) + z[547] * (z[211] * z[58] + z[223] * z[57]) + z[548] * (z[333] * z[77] + z[345] * z[76]) + z[548] * (z[378] * z[84] + z[390] * z[83])) - z[1159] * z[42]) - lff * (lrx2 * z[41] + lry2 * z[42])) - 0.5 * z[545] * (lrffo * z[49] + lrfo * z[53] + 2 * lff * z[42])) - 0.5 * z[545] * (((lrffo * z[71] - 2 * z[91] * z[67]) - 2 * z[229] * z[61]) - 2 * z[250] * z[63])) - z[1213]
