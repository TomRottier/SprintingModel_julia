C**   The name of this program is model/13seg_ad/model_ad.f
C**   Created by AUTOLEV 3.2 on Wed Jun 22 18:10:17 2022
...
C**   Open input and output files
      OPEN(UNIT=20, FILE='model/13seg_ad/model_ad.in', STATUS='OLD')
      OPEN(UNIT=21, FILE='model/13seg_ad/model_ad.1',  STATUS='UNKNOWN')
      OPEN(UNIT=22, FILE='model/13seg_ad/model_ad.2',  STATUS='UNKNOWN')
      OPEN(UNIT=23, FILE='model/13seg_ad/model_ad.3',  STATUS='UNKNOWN')
      OPEN(UNIT=24, FILE='model/13seg_ad/model_ad.4',  STATUS='UNKNOWN')
      OPEN(UNIT=25, FILE='model/13seg_ad/model_ad.5',  STATUS='UNKNOWN')
      OPEN(UNIT=26, FILE='model/13seg_ad/model_ad.6',  STATUS='UNKNOWN')
...
6021  FORMAT(1X,'FILE: model/13seg_ad/model_ad.1 ',//1X,'*** ',99A1,///,
     &8X,'T',12X,'POP1X',10X,'POP1Y',10X,'POP2X',10X,'POP2Y',10X,'POP3X'
     &,10X,'POP3Y',10X,'POP4X',10X,'POP4Y',10X,'POP5X',10X,'POP5Y',10X,'
     &POP6X',10X,'POP6Y',10X,'POP7X',10X,'POP7Y',10X,'POP8X',10X,'POP8Y'
     &,10X,'POP9X',10X,'POP9Y',9X,'POP10X',9X,'POP10Y',9X,'POP11X',9X,'P
     &OP11Y',9X,'POP12X',9X,'POP12Y',9X,'POP13X',9X,'POP13Y',9X,'POP14X'
     &,9X,'POP14Y',9X,'POP15X',9X,'POP15Y',9X,'POP16X',9X,'POP16Y',10X,'
     &POCMX',10X,'POCMY',10X,'VOCMX',10X,'VOCMY',/,5X,'(UNITS)',8X,'(UNI
     ...
     &X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',/)
6022  FORMAT(1X,'FILE: model/13seg_ad/model_ad.2 ',//1X,'*** ',99A1,///,
     &8X,'T',13X,'Q1',13X,'Q2',13X,'Q3',13X,'U1',13X,'U2',13X,'U3',/,5X,
     &'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'
     &(UNITS)',8X,'(UNITS)',/)
6023  FORMAT(1X,'FILE: model/13seg_ad/model_ad.3 ',//1X,'*** ',99A1,///,
     &8X,'T',13X,'RRX',12X,'RRY',12X,'LRX',12X,'LRY',11X,'RRX1',11X,'RRY
     &1',11X,'RRX2',11X,'RRY2',11X,'LRX1',11X,'LRX2',11X,'LRY1',11X,'LRY
     &2',/,5X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNIT
     &S)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS
     &)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',/)
6024  FORMAT(1X,'FILE: model/13seg_ad/model_ad.4 ',//1X,'*** ',99A1,///,
     &8X,'T',12X,'RHTQ',11X,'LHTQ',11X,'RKTQ',11X,'LKTQ',11X,'RATQ',11X,
     &'LATQ',11X,'RMTQ',11X,'LMTQ',11X,'RSTQ',11X,'LSTQ',11X,'RETQ',11X,
     &'LETQ',/,5X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(
     &UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(U
     &NITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',/)
6025  FORMAT(1X,'FILE: model/13seg_ad/model_ad.5 ',//1X,'*** ',99A1,///,
     &8X,'T',13X,'RH',13X,'LH',13X,'RK',13X,'LK',13X,'RA',13X,'LA',12X,'
     &RMTP',11X,'LMTP',12X,'RS',13X,'LS',13X,'RE',13X,'LE',13X,'RH''',12
     &X,'LH''',12X,'RK''',12X,'LK''',12X,'RA''',12X,'LA''',11X,'RMTP''',
     &10X,'LMTP''',11X,'RS''',12X,'LS''',12X,'RE''',12X,'LE''',11X,'RH''
     &''',11X,'LH''''',11X,'RK''''',11X,'LK''''',11X,'RA''''',11X,'LA'''
     &'',10X,'RMTP''''',9X,'LMTP''''',10X,'RS''''',11X,'LS''''',11X,'RE'
     &'''',11X,'LE''''',/,5X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UN
     ...
     &,8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',
     &8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',/)
6026  FORMAT(1X,'FILE: model/13seg_ad/model_ad.6 ',//1X,'*** ',99A1,///,
     &8X,'T',12X,'KECM',12X,'HZ',13X,'PX',13X,'PY',/,5X,'(UNITS)',8X,'(U
     &NITS)',8X,'(UNITS)',8X,'(UNITS)',8X,'(UNITS)',/)
6997  FORMAT(/7X,'Error: Numerical integration failed to converge',/)
6999  FORMAT(//1X,'Input is in the file model/13seg_ad/model_ad.in',//1X
     &,'Output is in the file(s) model/13seg_ad/model_ad.i  (i=1, ..., 6
     &)',//1X,'The output quantities and associated files are listed in 
     &file model/13seg_ad/model_ad.dir',/)
7000  FORMAT(//,99A1,///)
7010  FORMAT( 1000(59X,E30.0,/) )
7011  FORMAT( 3(59X,E30.0,/), 1(59X,I30,/), 2(59X,E30.0,/) )
      STOP
7100  WRITE(*,*) 'Premature end of file while reading model/13seg_ad/mod
     &el_ad.in '
7101  WRITE(*,*) 'Error while reading file model/13seg_ad/model_ad.in'
      STOP
      END
...
C**   Quantities to be specified
     ...
     &+Z(496))
      ...
      Z(1157) = LRX1 + LRX2*Z(39)**2 + LRX2*Z(41)**2 + LRY2*Z(39)*Z(40) 
     &+ LRY2*Z(41)*Z(42) + RRX1*Z(72)*Z(290) + RRX1*Z(74)*Z(299) + RRX2*
     &Z(64)*Z(266) + RRX2*Z(66)*Z(274) + RRY1*Z(73)*Z(290) + RRY1*Z(75)*
     &Z(299) + RRY2*Z(65)*Z(266) + RRY2*Z(67)*Z(274) + Z(542)*(Z(1)*Z(32
     &5)+Z(2)*Z(319)) + Z(543)*(Z(39)*Z(40)+Z(41)*Z(42)) + Z(543)*(Z(73)
     &*Z(290)+Z(75)*Z(299)) + Z(544)*(Z(80)*Z(354)+Z(82)*Z(362)) + Z(544
     &)*(Z(87)*Z(399)+Z(89)*Z(407)) + Z(545)*(Z(39)*Z(40)+Z(41)*Z(42)) +
     & Z(545)*(Z(61)*Z(232)+Z(63)*Z(240)) + Z(546)*(Z(36)*Z(177)+Z(38)*Z
     &(181)) + Z(546)*(Z(61)*Z(232)+Z(63)*Z(240)) + Z(547)*(Z(54)*Z(198)
     &+Z(55)*Z(193)) + Z(547)*(Z(57)*Z(219)+Z(58)*Z(213)) + Z(548)*(Z(76
     &)*Z(341)+Z(77)*Z(334)) + Z(548)*(Z(83)*Z(386)+Z(84)*Z(379))
      Z(1158) = LRY1 + LRX2*Z(39)*Z(40) + LRX2*Z(41)*Z(42) + LRY2*Z(40)*
     &*2 + LRY2*Z(42)**2 + RRX1*Z(72)*Z(291) + RRX1*Z(74)*Z(300) + RRX2*
     &Z(64)*Z(267) + RRX2*Z(66)*Z(275) + RRY1*Z(73)*Z(291) + RRY1*Z(75)*
     &Z(300) + RRY2*Z(65)*Z(267) + RRY2*Z(67)*Z(275) + Z(542)*(Z(1)*Z(32
     &6)+Z(2)*Z(320)) + Z(543)*(Z(40)**2+Z(42)**2) + Z(543)*(Z(73)*Z(291
     &)+Z(75)*Z(300)) + Z(544)*(Z(80)*Z(355)+Z(82)*Z(363)) + Z(544)*(Z(8
     &7)*Z(400)+Z(89)*Z(408)) + Z(545)*(Z(40)**2+Z(42)**2) + Z(545)*(Z(6
     &1)*Z(233)+Z(63)*Z(241)) + Z(546)*(Z(36)*Z(178)+Z(38)*Z(182)) + Z(5
     &46)*(Z(61)*Z(233)+Z(63)*Z(241)) + Z(547)*(Z(54)*Z(199)+Z(55)*Z(194
     &)) + Z(547)*(Z(57)*Z(220)+Z(58)*Z(214)) + Z(548)*(Z(76)*Z(342)+Z(7
     &7)*Z(335)) + Z(548)*(Z(83)*Z(387)+Z(84)*Z(380))
      Z(1176) = IFF*Z(136)
      Z(1178) = ILA*Z(150)
      Z(1180) = IRF*Z(124)
      Z(1182) = ISH*Z(116)
     ...
     &Z(11)*Z(229)*Z(486)-2*Z(229)*Z(563)*Z(487)-2*Z(250)*Z(564)*Z(487))
      ...
      Z(1287) = Z(264)*RRX2*Z(64) + Z(264)*RRY2*Z(65) + Z(279)*RRX2*Z(66
     &) + Z(279)*RRY2*Z(67) + Z(287)*RRX1*Z(72) + Z(287)*RRY1*Z(73) + Z(
     &311)*RRX1*Z(74) + Z(311)*RRY1*Z(75) + Z(542)*(Z(317)*Z(2)+Z(328)*Z
     ...
     &*Z(83)) - Z(1159)*Z(42) - LFF*(LRX2*Z(41)+LRY2*Z(42)) - 0.5D0*Z(54
     &5)*(LRFFO*Z(49)+LRFO*Z(53)+2*LFF*Z(42)) - 0.5D0*Z(545)*(LRFFO*Z(71
...
C**   Evaluate output quantities
     ...
     &1161)*Z(57) - Z(265)*RRX2*Z(64) - Z(265)*RRY2*Z(65) - Z(280)*RRX2*
     &Z(66) - Z(280)*RRY2*Z(67) - Z(288)*RRX1*Z(72) - Z(288)*RRY1*Z(73) 
     &- Z(312)*RRX1*Z(74) - Z(312)*RRY1*Z(75) - Z(543)*(Z(288)*Z(73)+Z(3
     &06)*Z(75))
     ...
     &1)*Z(230)*Z(486)-Z(230)*Z(563)*Z(487)-Z(238)*Z(564)*Z(487))
      Z(1280) = Z(1159)*Z(42) + LFF*(LRX2*Z(41)+LRY2*Z(42)) + 0.5D0*Z(54
     &5)*(LRFFO*Z(49)+LRFO*Z(53)+2*LFF*Z(42)) + Z(1225) - Z(262)*RRX2*Z(
     &64) - Z(262)*RRY2*Z(65) - Z(272)*RRX2*Z(66) - Z(272)*RRY2*Z(67) - 
     &Z(285)*RRX1*Z(72) - Z(285)*RRY1*Z(73) - Z(295)*RRX1*Z(74) - Z(295)
     &*RRY1*Z(75) - Z(542)*(Z(317)*Z(2)+Z(324)*Z(1)) - Z(543)*(Z(285)*Z(
     &73)+Z(295)*Z(75)) - Z(544)*(Z(352)*Z(80)+Z(360)*Z(82)) - Z(544)*(Z
     &(397)*Z(87)+Z(405)*Z(89)) - Z(545)*(Z(230)*Z(61)+Z(238)*Z(63)) - Z
     &(546)*(Z(176)*Z(36)+Z(186)*Z(38)) - Z(546)*(Z(230)*Z(61)+Z(238)*Z(
     &63)) - Z(547)*(Z(192)*Z(55)+Z(202)*Z(54)) - Z(547)*(Z(211)*Z(58)+Z
     &(218)*Z(57)) - Z(548)*(Z(332)*Z(77)+Z(339)*Z(76)) - Z(548)*(Z(377)
     &*Z(84)+Z(384)*Z(83))
     ...
     &(1232) - Z(1164)*Z(63) - Z(260)*RRX2*Z(64) - Z(260)*RRY2*Z(65) - Z
     &(281)*RRX2*Z(66) - Z(281)*RRY2*Z(67) - Z(289)*RRX1*Z(72) - Z(289)*
     &RRY1*Z(73) - Z(313)*RRX1*Z(74) - Z(313)*RRY1*Z(75) - Z(543)*(Z(289
     &)*Z(73)+Z(307)*Z(75))
     ...
     &Z(486)-Z(231)*Z(563)*Z(487)-Z(239)*Z(564)*Z(487))
      Z(1282) = Z(1159)*Z(42) + LFF*(LRX2*Z(41)+LRY2*Z(42)) + 0.5D0*Z(54
     &5)*(LRFFO*Z(49)+LRFO*Z(53)+2*LFF*Z(42)) + Z(1237) - Z(263)*RRX2*Z(
     &64) - Z(263)*RRY2*Z(65) - Z(273)*RRX2*Z(66) - Z(273)*RRY2*Z(67) - 
     &Z(286)*RRX1*Z(72) - Z(286)*RRY1*Z(73) - Z(296)*RRX1*Z(74) - Z(296)
     &*RRY1*Z(75) - Z(542)*(Z(318)*Z(2)+Z(323)*Z(1)) - Z(543)*(Z(286)*Z(
     &73)+Z(296)*Z(75)) - Z(544)*(Z(351)*Z(80)+Z(359)*Z(82)) - Z(544)*(Z
     &(396)*Z(87)+Z(404)*Z(89)) - Z(545)*(Z(231)*Z(61)+Z(239)*Z(63)) - Z
     &(546)*(Z(176)*Z(36)+Z(186)*Z(38)) - Z(546)*(Z(231)*Z(61)+Z(239)*Z(
     &63)) - Z(547)*(Z(192)*Z(55)+Z(197)*Z(54)) - Z(547)*(Z(212)*Z(58)+Z
     &(217)*Z(57)) - Z(548)*(Z(331)*Z(77)+Z(338)*Z(76)) - Z(548)*(Z(376)
     &*Z(84)+Z(383)*Z(83))
     ...
     &83)*RRX1*Z(72) - Z(283)*RRY1*Z(73) - Z(314)*RRX1*Z(74) - Z(314)*RR
     &Y1*Z(75) - LRF*(RRX2*Z(66)+RRY2*Z(67)) - Z(543)*(Z(283)*Z(73)+Z(30
     &8)*Z(75))
     ...
     &28)*Z(563)*Z(487)-Z(236)*Z(564)*Z(487))
      Z(1284) = Z(1159)*Z(42) + LFF*(LRX2*Z(41)+LRY2*Z(42)) + 0.5D0*Z(54
     &5)*(LRFFO*Z(49)+LRFO*Z(53)+2*LFF*Z(42)) + Z(1248) - Z(261)*RRX2*Z(
     &64) - Z(261)*RRY2*Z(65) - Z(270)*RRX2*Z(66) - Z(270)*RRY2*Z(67) - 
     &Z(284)*RRX1*Z(72) - Z(284)*RRY1*Z(73) - Z(294)*RRX1*Z(74) - Z(294)
     &*RRY1*Z(75) - Z(542)*(Z(316)*Z(2)+Z(322)*Z(1)) - Z(543)*(Z(284)*Z(
     &73)+Z(294)*Z(75)) - Z(544)*(Z(350)*Z(80)+Z(358)*Z(82)) - Z(544)*(Z
     &(395)*Z(87)+Z(403)*Z(89)) - Z(545)*(Z(228)*Z(61)+Z(236)*Z(63)) - Z
     &(546)*(Z(176)*Z(36)+Z(180)*Z(38)) - Z(546)*(Z(228)*Z(61)+Z(236)*Z(
     &63)) - Z(547)*(Z(191)*Z(55)+Z(196)*Z(54)) - Z(547)*(Z(210)*Z(58)+Z
     &(216)*Z(57)) - Z(548)*(Z(330)*Z(77)+Z(337)*Z(76)) - Z(548)*(Z(375)
     &*Z(84)+Z(382)*Z(83))
