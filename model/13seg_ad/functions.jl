...
function io(sol, t)
    ...
    z[1279] = ((((((((((z[546] * (z[234] * z[61] - z[247] * z[63]) + 0.5 * z[545] * (((lrffo * z[71] + 2 * z[234] * z[61]) - 2 * z[91] * z[67]) - 2 * z[251] * z[63]) + z[1220]) - z[1161] * z[57]) - z[265] * rrx2 * z[64]) - z[265] * rry2 * z[65]) - z[280] * rrx2 * z[66]) - z[280] * rry2 * z[67]) - z[288] * rrx1 * z[72]) - z[288] * rry1 * z[73]) - z[312] * rrx1 * z[74]) - z[312] * rry1 * z[75]) - z[543] * (z[288] * z[73] + z[306] * z[75])
    ...
    z[1280] = (((((((((((((((((((z[1159] * z[42] + lff * (lrx2 * z[41] + lry2 * z[42]) + 0.5 * z[545] * (lrffo * z[49] + lrfo * z[53] + 2 * lff * z[42]) + z[1225]) - z[262] * rrx2 * z[64]) - z[262] * rry2 * z[65]) - z[272] * rrx2 * z[66]) - z[272] * rry2 * z[67]) - z[285] * rrx1 * z[72]) - z[285] * rry1 * z[73]) - z[295] * rrx1 * z[74]) - z[295] * rry1 * z[75]) - z[542] * (z[317] * z[2] + z[324] * z[1])) - z[543] * (z[285] * z[73] + z[295] * z[75])) - z[544] * (z[352] * z[80] + z[360] * z[82])) - z[544] * (z[397] * z[87] + z[405] * z[89])) - z[545] * (z[230] * z[61] + z[238] * z[63])) - z[546] * (z[176] * z[36] + z[186] * z[38])) - z[546] * (z[230] * z[61] + z[238] * z[63])) - z[547] * (z[192] * z[55] + z[202] * z[54])) - z[547] * (z[211] * z[58] + z[218] * z[57])) - z[548] * (z[332] * z[77] + z[339] * z[76])) - z[548] * (z[377] * z[84] + z[384] * z[83])
    ...
    z[1281] = ((((((((((0.5 * z[545] * ((lrffo * z[71] - 2 * lsh * z[63]) - 2 * z[91] * z[67]) + z[1232]) - z[1164] * z[63]) - z[260] * rrx2 * z[64]) - z[260] * rry2 * z[65]) - z[281] * rrx2 * z[66]) - z[281] * rry2 * z[67]) - z[289] * rrx1 * z[72]) - z[289] * rry1 * z[73]) - z[313] * rrx1 * z[74]) - z[313] * rry1 * z[75]) - z[543] * (z[289] * z[73] + z[307] * z[75])
    ...
    z[1282] = (((((((((((((((((((z[1159] * z[42] + lff * (lrx2 * z[41] + lry2 * z[42]) + 0.5 * z[545] * (lrffo * z[49] + lrfo * z[53] + 2 * lff * z[42]) + z[1237]) - z[263] * rrx2 * z[64]) - z[263] * rry2 * z[65]) - z[273] * rrx2 * z[66]) - z[273] * rry2 * z[67]) - z[286] * rrx1 * z[72]) - z[286] * rry1 * z[73]) - z[296] * rrx1 * z[74]) - z[296] * rry1 * z[75]) - z[542] * (z[318] * z[2] + z[323] * z[1])) - z[543] * (z[286] * z[73] + z[296] * z[75])) - z[544] * (z[351] * z[80] + z[359] * z[82])) - z[544] * (z[396] * z[87] + z[404] * z[89])) - z[545] * (z[231] * z[61] + z[239] * z[63])) - z[546] * (z[176] * z[36] + z[186] * z[38])) - z[546] * (z[231] * z[61] + z[239] * z[63])) - z[547] * (z[192] * z[55] + z[197] * z[54])) - z[547] * (z[212] * z[58] + z[217] * z[57])) - z[548] * (z[331] * z[77] + z[338] * z[76])) - z[548] * (z[376] * z[84] + z[383] * z[83])
    ...
    z[1283] = ((((((0.5 * z[545] * (lrffo * z[71] - 2 * z[91] * z[67]) + z[1243]) - z[283] * rrx1 * z[72]) - z[283] * rry1 * z[73]) - z[314] * rrx1 * z[74]) - z[314] * rry1 * z[75]) - lrf * (rrx2 * z[66] + rry2 * z[67])) - z[543] * (z[283] * z[73] + z[308] * z[75])
