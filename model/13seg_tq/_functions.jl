...
function kecm(sol, t)
    ...
    @inbounds q1, q10, q11, q2, q3, q4, q5, q6, q7, q8, q9, u1, u10, u11, u2, u3, u4, u5, u6, u7, u8, u9 = sol(t)
    lsp, rsp, lep, rep = _lsp(t), _rsp(t), _lep(t), _rep(t)

    # set z array values
    eom(SA[q1, q10, q11, q2, q3, q4, q5, q6, q7, q8, q9, u1, u10, u11, u2, u3, u4, u5, u6, u7, u8, u9],sol.prob.p,t)
    io(sol, t)
...
function io(sol, t)
 ...
 @inbounds q1, q10, q11, q2, q3, q4, q5, q6, q7, q8, q9, u1, u10, u11, u2, u3, u4, u5, u6, u7, u8, u9 = sol(t)
    ...
    # specified variables
    rs = _rs(t); ls = _ls(t); re = _re(t); le = _le(t); rsp = _rsp(t); lsp = _lsp(t); repp = _repp(t); rspp = _rspp(t); lepp = _lepp(t); lspp = _lspp(t); rep = _rep(t); lep = _lep(t)
